...
public final class Felix
{
	 ...
	 */
	public static final ResourceBundle CONFIGURATION = ResourceBundle.getBundle("Felix");

	/**
	 * Fichier de configuration de l'IHM de Felix.
	 */
	...
	{
		System.out.println("Felix v0.4.2");
